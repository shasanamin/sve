...
def main(args):
    ...
    if args.arch == 'resnet20':
        ...
        model = Roberta('roberta-base', args.num_classes)
    else:
    ...
    elif args.selection_method == "rande":
        from trainers import RandETrainer
        trainer = RandETrainer(
            args,
            model,
            train_dataset,
            val_loader,
        )
    elif args.selection_method == "randg":
        from trainers import RandGTrainer
        trainer = RandGTrainer(
            args,
            model,
            train_dataset,
            val_loader,
        )
    elif args.selection_method == "crest_random":
        from trainers import CRESTRandomTrainer
        trainer = CRESTRandomTrainer(
            args,
            model,
            train_dataset,
            val_loader,
        )
    elif args.selection_method == "crest_rande":
        from trainers import CRESTRandomETrainer
        trainer = CRESTRandomETrainer(
            args,
            model,
            train_dataset,
            val_loader,
