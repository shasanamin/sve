...
def get_args():
    ...
    # General options
    parser.add_argument("--arch", default="resnet20", choices=['resnet20', 'resnet18', 'resnet50', 'roberta'],
        help="model architecture")
    parser.add_argument('--data_dir', default='/scratch/gilbreth/mahmood6/datasets')
    parser.add_argument('--dataset', default='cifar10', choices=['cifar10', 'cifar100', 'tinyimagenet', 'snli', 'cifar10_1dp', 'cifar100_1dp', 'cifar10_10dp', 'cifar100_10dp'],
    ...
    parser.add_argument("--save_dir", default="/scratch/gilbreth/mahmood6/crest/outputs", type=str,
        help="The directory used to save output")
    parser.add_argument("--detailed_naming", default=True, type=parse_bool, const=True, nargs='?',
        help="update save directory name to include parameter details")
    parser.add_argument("--save_freq", type=int, default=10,
        help="Saves checkpoints at every specified number of epochs")
    parser.add_argument("--gpu", type=int, nargs='+', default=[0])

    parser.add_argument("--selection_method", default="crest", choices=['none', 'random', 'crest', 'rande', 'randg', 'crest_random', 'crest_rande'],
    ...
    # dropping examples below a loss threshold (critical for speed?)
    ...
    # rande/randg/crest_random options
    parser.add_argument('--sample_with_rep', default=False, type=parse_bool, const=True, nargs='?', help='subset selection with or without replacement')
    parser.add_argument('--switch_epoch', default=50, type=int, help='epoch number to switch from CREST to Random')
